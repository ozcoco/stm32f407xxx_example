...
void LowPowerAccelOnlyMPU6050()
{
    ...
    MPU6050_DELAY_MS(100); // Add delay for accumulation of samples
...
void initMPU6050()
{
    ...
    //  MPU6050_DELAY_MS(100); // Delay 100 ms for PLL to get established on x-axis gyro; should check for PLL ready interrupt
...
void calibrateMPU6050(float* dest1, float* dest2)
{
    ...
    MPU6050_DELAY_MS(80); // accumulate 80 samples in 80 milliseconds = 960 bytes
...
// Should return percent deviation from factory trim values, +/- 14 or less deviation is a pass
{
    ...
    MPU6050_DELAY_MS(250); // Delay a while to let the device execute the self-test
...
void writeByte(uint8_t address, uint8_t subAddress, uint8_t data)
{
    ...
    US_I2C_MEM_WRITE(address, subAddress, &data, 1);
}
...
uint8_t readByte(uint8_t address, uint8_t subAddress)
{
    ...
    US_I2C_MEM_READ(address, subAddress, &data, 1);
